...
async function generateFromMessages(messages, channel, options = {}) {
    ...
    const html = await (0, generator_1.default)({
        ...
        poweredBy: (_f = options.poweredBy) !== null && _f !== void 0 ? _f : false,
        footerText: (_g = options.footerText) !== null && _g !== void 0 ? _g : 'Zapisano {number} {wiadomosci}.',
    ...
    return new discord_js_1.AttachmentBuilder(Buffer.from(html), {
        name: (_k = options.filename) !== null && _k !== void 0 ? _k : `transkrypcja-${channel.id}.html`,
    });
}
/**
 *
